// Tambahkan parameter 'activePage'
export default function navigation(activePage = 'whatsapp'){

    // Helper untuk cek apakah menu ini aktif
    const isActive = (name) => activePage === name ? 'active' : '';

    return `
    <div class="bottom-nav">
        <div onclick="load('whatsapp')" class="nav-item ${isActive('whatsapp')}">
            <div class="nav-icon">
        ...
        <div onclick="load('template')" class="nav-item ${isActive('template')}">
            <div class="nav-icon">
        ...
        <div onclick="load('siswa')" class="nav-item ${isActive('siswa')}">
            <div class="nav-icon">
                <svg class="nav-icon-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div onclick="load('blast')" class="nav-item ${isActive('blast')}">
            <div class="nav-icon">
                <svg class="nav-icon-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div onclick="load('log')" class="nav-item ${isActive('log')}">
            <div class="nav-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
